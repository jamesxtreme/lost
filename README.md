...
## Deployment Methods
---
1.  ***Get `SESSION ID FOR 𝙹𝙾𝚁𝙳𝙰𝙽-𝙹𝙾𝙴𝙻𝚂𝚃𝙰𝚁🤖` by [`SCANNING QR`](https://j-jweb-87c8ef31d970.herokuapp.com/) or [`SCANNING QR2`](https://replit.com/@jordanzzz4444/JJ-PAIR#index.js) Or [`PARING CODE`](-------NOT-AVAILABLE-FOR-NOW--------). And then `Go-to Whatapp>Three dots>Linked Devices`***
